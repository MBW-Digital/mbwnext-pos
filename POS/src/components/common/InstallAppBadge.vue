			...
			<div class="px-3 py-2.5">
				<div class="flex items-center gap-2">
					...
					<div class="flex-shrink-0">
						<div class="w-10 h-10 rounded-lg flex items-center justify-center shadow-sm" style="background-color: #c4161c;">
					...
					<div class="flex items-center gap-1.5 flex-shrink-0">
						<button
							...
							style="background-color: #c4161c; color: #ffffff;"
						>
							{{  __('Install') }}
						</button>
						<button
